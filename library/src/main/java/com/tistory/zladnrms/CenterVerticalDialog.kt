...
class CenterVerticalDialog constructor(context: Context) : Dialog(context), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        layoutLeftAction.setOnClickListener(this@CenterVerticalDialog)
        layoutRightAction.setOnClickListener(this@CenterVerticalDialog)
    ...
    interface ClimaxDialogListener {
        fun onClick(climaxDialog: CenterVerticalDialog)
    }
        ...
        when(view.id) {
            R.id.layout_left_action -> {
                mLeftActionListener?.let {
                    it.onClick(this@CenterVerticalDialog)
                }
            }
    ...
    fun setLeftActionListener(listener: ClimaxDialogListener): CenterVerticalDialog {
        mLeftActionListener = listener
        return this
    }

    fun setRightActionListener(listener: ClimaxDialogListener): CenterVerticalDialog {
